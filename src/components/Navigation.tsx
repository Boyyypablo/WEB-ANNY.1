...
const Navigation = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-white shadow-lg md:shadow-none md:relative md:top-0 md:w-auto md:ml-6 z-10">
      <div className="flex justify-around md:justify-start md:gap-8 items-center py-3 px-4">
